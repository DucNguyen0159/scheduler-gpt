Introduction
You are tasked with implementing three process scheduling algorithms: FIFO (First In, First Out), Pre-emptive SJF (Shortest Job First), and Round Robin in RustLinks to an external site., but using ChatGPT. ChatGPT's implementation should be able to simulate the scheduling of multiple processes under each algorithm and calculate their turnaround time, response time, and wait time.
...
Scheduler runs 2-process load on FCFS
3 pts
Full Marks
0 pts
No Marks
/ 3 pts
Scheduler Runs 5-process load on FCFS
3 pts
Full Marks
0 pts
No Marks
/ 3 pts
Scheduler runs 10-process load on RR
3 pts
Full Marks
0 pts
No Marks
/ 3 pts
Scheduler runs 2-process load on SFJ (preemptive)
3 pts
Full Marks
0 pts
No Marks
/ 3 pts
Scheduler Runs 5-process load on SFJ (preemptive)
3 pts
Full Marks
0 pts
No Marks
/ 3 pts
Scheduler runs 10-process load on SFJ (preemptive)
3 pts
Full Marks
0 pts
No Marks
/ 3 pts
Scheduler runs 2-process load on RR
3 pts
Full Marks
0 pts
No Marks
/ 3 pts
Scheduler Runs 5-process load on RR
3 pts
Full Marks
0 pts
No Marks
...
No Marks
/ 3 pts
FCFS completes flawlessly
1 pts
Full Marks
0 pts
No Marks
/ 1 pts
SJF completes flawlessly
1 pts
Full Marks
0 pts
No Marks
/ 1 pts
RR completes flawlessly
1 pts
Full Marks
0 pts
No Marks
/ 1 pts
All team members contributed at least one ChatGPT conversation
...
view longer description
6 pts
Full Marks - Evidence of iteration accompanied by discussion
Multiple prompts were attempted showing a clear progression of conversation with ChatGPT. Prompts are accompanied by a discussion explaining their reasoning as to why they chose the prompts and how they decided when to stop prompting.
4 pts
Adequate iteration, no discussion
The team supplied a conversation that does show an attempt at engaging with ChatGPT, but failed to provide any discussion describing their iterative process.
2 pts
Minimal iteration, no discussion
There's minimal evidence that the team engaged with ChatGPT in an iterative fashion. They may have provided one or two different prompts, but did not provide any explanatory text or discussion of their iteration process.
0 pts
Did not engage with ChatGPT at all
/ 6 pts
Evaluating the AI - Correctness
view longer description
10 pts
Full Marks - Answered the questions with a detailed description of AI output and their response.
Answered both questions and additionally provided a detailed description of how ChatGPT did or did not meet their objectives. Description should include specifics on what code needed to be fixed and how they addressed it (whether by fixing it themselves or adjusting their prompting).
7 pts
Addressed the questions, but provided minimal description.
Answered both questions, but did not provide much detail as to how the team addressed the issues. Some description is present of the team response, but it's vague.
5 pts
Answered both questions, but provided no additional details
Answered both questions, but did not provide a description of how the team responded to the AI's failures.
0 pts
No Marks
/ 10 pts
Evaluating the AI - Efficiency
view longer description
10 pts
Full Marks
This is a tough one and for now, we'll use a binary evaluation. Full points if they addressed the issue, none otherwise.
0 pts
No Marks
/ 10 pts
Evaluating the AI - Readability
view longer description
10 pts
Full Marks - All points addressed with some discussion on their findings
All questions answered with good descriptions of the AI output, supported by meaningful discussion and/or interpretation of the AI output.
7 pts
...
5 pts
Answered the questions, but did not provide additional description or discussion
Answered the questions, but did not elaborate or interpret further. i.e. "The code was easy to understand and follow. The code used meaningful variable names." etc.
0 pts
No Marks
/ 10 pts
Evaluating the AI - Innovation
view longer description
10 pts
Full Marks
This is another binary evaluation as the question didn't prompt for further elaboration.
0 pts
No Marks
/ 10 pts
Evaluating the AI - Final Evaluation
view longer description
10 pts
Full Marks - All points addressed with some discussion on their findings
All questions answered with good descriptions of the AI output, supported by meaningful discussion and/or interpretation of the AI output.
...
No Marks
/ 10 pts
Evaluating the AI - Completeness
view longer description
10 pts
Full Marks - All points addressed with some discussion on their findings
All questions answered with good descriptions of the AI output, supported by meaningful discussion and/or interpretation of the AI output.
...
5 pts
Answered the questions, but did not provide additional description or discussion
Answered the questions, but did not elaborate or interpret further. i.e. "The code didn't handle any errors."
0 pts
No Marks
/ 10 pts